...
class TestFriends < MiniTest::Test
  ...
  def test_like_food_not
    result = like_food(@person3,"spinach")
  ...
  def test_add_friend
    result = add_friend(@person4, "Scrappy-Doo")
...
def test_loan
  loan(@person5, @person4, 20)
  assert_equal(@person5[:monies], 80)
  assert_equal(@person4[:monies], 40)
end
